...
<!-- Mirrored from adminlte.io/themes/v3/pages/layout/fixed-topnav.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Mar 2025 10:24:03 GMT -->
<head>
  <meta charset="utf-8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="fixed-topnav.html" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fixed Navbar</p>
                </a>
              </li>
